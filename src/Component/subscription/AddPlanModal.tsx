...
useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="px-8 pt-8 pb-4 flex justify-between items-center">
          <h2 className="text-xl md:text-2xl font-black text-titleColor leading-5 md:leading-8 tracking-tight">  {editingPlan ? "Edit Plan" : "Add New Plan"}</h2>
          <button 
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full px-5 py-4 rounded-2xl border border-stone-100 bg-white text-stone-800 font-bold focus:outline-none focus:ring-2 focus:ring-[#845E84]/20 focus:border-[#845E84] transition-all"
              />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-black uppercase tracking-[1.5px] text-[#4A3A3799] block">
    ...
    onSave(newPlan);
            ...
            className="flex-1 px-8 py-4 rounded-2xl bg-[#845E84] text-white ftext-sm font-black  tracking-[0.5px]  thover:bg-[#6d4d6d] shadow-lg shadow-[#845E84]/20 transition-all order-1 sm:order-2 cursor-pointer"
          >
