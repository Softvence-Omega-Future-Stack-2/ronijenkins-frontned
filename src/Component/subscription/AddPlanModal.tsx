...
const AddPlanModal: React.FC<ModalProps> = ({
  ...
  useEffect(() => {
    if (editingPlan) {
      setTitle(editingPlan.name || "");
      setPrice(editingPlan.monthlyPrice?.toString() || "");
      setAnnualPrice(editingPlan.yearlyPrice?.toString() || "");
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center w-full rounded-2xl border border-stone-100 bg-white focus-within:ring-2 focus-within:ring-[#845E84]/20 focus-within:border-[#845E84] transition-all overflow-hidden">
                <span className="pl-5 pr-2 text-stone-400 font-bold text-base select-none">
                  $
                </span>
                <input
                  type="number"
          ...
          <button
            onClick={() => {
              onSave({
                ...
                yearlyPrice: Number(annualPrice),
              });
            }}
