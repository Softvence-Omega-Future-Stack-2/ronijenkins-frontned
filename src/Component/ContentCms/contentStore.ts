...
const initialContent: ContentItem[] = [
  ...
  { id: 2, title: "10-Minute Evening Meditation", category: "MENTAL HEALTH", status: "PUBLISHED", type: "meditation", views: "8.2k", date: "Feb 10, 2026", seoDescription: "A calming 10-minute evening meditation.", readTime: 10, notifyUsers: true, isLocked: false, meditationSteps: [{ id: 1, instruction: "Close your eyes and breathe deeply", duration: 30 }, { id: 2, instruction: "Focus on your breath", duration: 60 }] },
