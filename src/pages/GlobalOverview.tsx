    ...
    <div className="w-full p-3 md:p-8 ">
      <div className="flex flex-col  md:flex-col lg:flex-row  gap-4 items-center justify-between mb-8">
        ...
        <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center gap-4">
          <button onClick={handleExport} className="flex w-full sm:w-auto justify-center  gap-2 bg-white text-titleColor font-extrabold border border-borderColor px-5 py-3 rounded-2xl cursor-pointer">
            <Download/>
             Export Report
          </button>
